...
var IspwDownloader_1 = require("./IspwDownloader");
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var cliArguments, ispwDownloader, downloadSourceType;
        return __generator(this, function (_a) {
            try {
                cliArguments = new Map();
                ispwDownloader = new IspwDownloader_1.IspwDownloader();
                ispwDownloader.buildCommonArgumentsToDownloadSource(cliArguments);
                downloadSourceType = tl.getInput('downloadSourceType', true);
